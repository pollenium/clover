    ...
    ContractReader.prototype.fetchLogs = function (arg) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fetchEthersLogs(__assign({}, arg))];
                    case 1:
                        ethersLogs = _a.sent();
...
function convertContractReaderFilterBlockFlagToEthersFilterBlockFlag(arg) {
    if (typeof arg === 'string') {
        return arg;
    }
    return new pollenium_buttercup_1.Uint256(arg).toNumber();
}
