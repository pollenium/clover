...
var ContractWriter = /** @class */ (function () {
    ...
    ContractWriter.prototype.genStateChange = function (ethersTransactionPromise) {
        return __awaiter(this, void 0, void 0, function () {
            var transaction, transactionHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ethersTransactionPromise];
                    case 1:
                        transaction = _a.sent();
                        transactionHash = pollenium_uvaursi_1.Uu.fromHexish(transaction.hash);
                        return [2 /*return*/, new StateChange_1.StateChange({ provider: this.struct.signer.provider, transactionHash: transactionHash })];
                }
            });
        });
    };
