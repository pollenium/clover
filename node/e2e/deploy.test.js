...
exports.daiPrimrose = new pollenium_primrose_1.Primrose();
exports.enginePrimrose = new pollenium_primrose_1.Primrose();
var dai;
var engine;
describe('dai', function () {
    test('deploy', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new pollenium_dianella_1.DaishDeployer({
                        signer: params_1.deployer.getSigner()
                    }).deploy({
                        totalSupply: 1000
                    })];
                case 1:
                    deployStruct = _a.sent();
                    exports.daiPrimrose.resolve(deployStruct.address);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    test('deploy', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    deployStruct = _a.sent();
                    exports.enginePrimrose.resolve(deployStruct.address);
                    return [2 /*return*/];
            }
        });
    }); });
